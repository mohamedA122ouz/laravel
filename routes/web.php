...
Route::controller(ProductsController::class)->group(function () {
    ...
    Route::delete("/product/delete/{currentProduct}", "Delete");
    Route::patch('/product/edit/{currentProduct}', "EditPost");
    Route::get('/create', "Input");
    Route::get('/product/edit/{product}', "EditGet");
    Route::get('/', "Index");
    Route::get("/product/{products}", "Products");
});
Route::view("/aboutme", "aboutme");
Route::view("/allorders", "allorders", ["orders" => Order::with(['user', 'product'])->paginate(1)]);
